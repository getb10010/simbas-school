...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl px-6 h-16 flex items-center justify-between glass rounded-full shadow-2xl flex-shrink-0">
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          ...
          <Button variant="ghost" size="icon" className="lg:hidden glass rounded-full w-10 h-10 border border-white/20 p-0 flex items-center justify-center overflow-hidden">
